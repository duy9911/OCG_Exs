...
INSERT INTO `order` (`name`, `currency`, `created_at`, `updated_at`, `processed_at`, `cancelled_at`, `cart_token`, `total_price`, `checkout_token`, `total_weight_in_gram`, `transaction_id`, `customer_name`, `email`, `client_ip`, `client_country_code`, `phone`, `payment_gateway`, `fulfilled_at`, `additional_information`,`thankyou_email_sent`) VALUES
('#sb-01', 'USD', NOW(), NOW(), NOW(), NULL, '98ddd1jsg761g8yt1ghdk', 121, '8uhfsafklluhsyavnx98hsoc0', 0.5, 738892783, 'Truong Bui Van', 'truongbui@shopbase.com', '58.167.16.18', 'VN', '+84356172989', 'Paypal express', NULL, 0, False);